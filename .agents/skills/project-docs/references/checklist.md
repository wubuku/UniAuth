...
- [ ] Existing file remains at its original path
- [ ] Lifecycle is marked Historical in the applicable index
- [ ] Current replacement or authoritative guide is linked
- [ ] Existing inbound links remain valid
- [ ] Any explicitly approved relocation updates all references
...
- [ ] New historical files use a date prefix when the repository convention calls for it
- [ ] New filenames avoid spaces unless the repository convention uses them
- [ ] New filenames are descriptive rather than generic
- [ ] Existing files are not renamed merely to satisfy naming conventions
